...
save(EWA_self_simulation,file="EWA_self_simulation.RData")
...
table(EWA_self_simulation[, "condition"],c("random","Naive_Bayes","QL","EWA","S_EWA")[apply(EWA_self_simulation[,c("Random_2LL","NB_2LL","QL_2LL","EWA_2LL","S_EWA_2LL")],1,which.min)])
```
```{r}
