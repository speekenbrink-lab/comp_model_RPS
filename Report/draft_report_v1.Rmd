...
```{r exp1-score-by-opp, fig.cap = "Marginal means of players scores by game and type of opponents", fig.align='center'}

knitr::include_graphics("../Report/images/exp1_earlyScore_by_opp.png", dpi = 108)
...
dat2_6 <- read.csv(file = "../exp1_early_rounds.csv")
...
```{r exp2-anova, results = "asis", echo=FALSE}
