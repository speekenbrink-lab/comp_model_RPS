...
Hence, we ran a total of two experiments where human participants played against computer opponents a total of 3 different games. In the following sections, we wwill describe first the methods used in the first experiments and look at the results, then we will do the same for the second experiment. 
...
p2 <- ggerrorplot(dat2_6, x = "game.f", y = "early_score", group = 1, color="game.f", desc_stat = "mean_ci",palette = c("#00AFBB", "#E7B800", "#FC4E07"), order = c("RPS", "FWG","NUM"), ylab = "Score", xlab = "Games")
...
```{r Anova exp 2, echo = FALSE, warning=FALSE}
...
```{r exp1-comp-models, fig.cap = "Histogram of best fitting computational models for experiment 1", fig.align='center'}
...
```{r exp2-comp-models, fig.cap = "Histogram of best fitting computational models for experiment 2", fig.align='center'}

knitr::include_graphics("../Report/images/exp2_comp_models.png", dpi = 108)
...
knitr::include_graphics("../Report/images/exp1_cumScores.png", dpi = 108)
