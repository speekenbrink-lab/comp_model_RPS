...
```{r}
# 
# Q_learn <- function(beta,lambda,data){
#   # actions 
#   # beta= inverse temperature parameter in softmax choicd=e function
...
#   Q_vals_RPS = rep(0.0,3)
#   names(Q_vals_RPS) <- c("R","P","S")
#   Q_vals_FWG = rep(0.0,3)
#   names(Q_vals_FWG) <- c("F","W","G")
#   Q_vals_NUM = rep(0.0,5)
