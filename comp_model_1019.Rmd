...
for(id in unique(dat$human_id)) {
  ...
  TR_bayes_modelling[[id]] <- DEoptim(fn=naive_bayes, lower = c(0.0,0.0), upper = c(1.0,1.0), data=tdat, opp_strategy_vec = c("level0","level1","level2"),return_value = "-2loglik", opp_mod_transfer = TRUE, control=list(trace = FALSE, parallelType=0,parVar = c("best_response")))
