...
TOM_model(c(0.5,0.1),test_data,c("level0","level1","level2"),"-2loglik", within_transfer = TRUE, btwn_transfer = TRUE)
```
...
for(id in unique(dat_exp2$human_id)) {
  ...
  exp2_BT[[id]] <- optim(c(0.1,0.1),fn=TOM_model,gr = NULL, data=tdat,opp_strategy_vec = c("level0","level1","level2"),return_value = "-2loglik", within_transfer = TRUE, btwn_transfer = TRUE,lower = c(0.01,0.01), upper = c(0.99,0.99), method="L-BFGS-B")
}
...
for(id in unique(dat_exp2$human_id)) {
  ...
  exp2_NO_BT[[id]] <- optim(c(0.1,0.1),fn=TOM_model,gr = NULL, data=tdat,opp_strategy_vec = c("level0","level1","level2"),return_value = "-2loglik", within_transfer = TRUE, btwn_transfer = FALSE, lower = c(0.01,0.01), upper = c(0.99,0.99), method="L-BFGS-B")
}
...
for(id in unique(dat_exp2$human_id)) {
  ...
  exp2_NO_Tr[[id]] <- optim(c(0.1,0.1),fn=TOM_model,gr = NULL, data=tdat,opp_strategy_vec = c("level0","level1","level2"),return_value = "-2loglik", within_transfer = FALSE , btwn_transfer = FALSE, lower = c(0.01,0.01), upper = c(0.99,0.99), method="L-BFGS-B")
}
...
# 
# load("exp2_BT.RData")
# load("exp2_NO_BT.RData")
# load("exp2_NO_Tr.RData")
...
```{r}
exp2_table_results <- table(exp2_results[, "condition"],c("random","TOM_BT","TOM_NBT", "TOM_NT", "QL_states","S_EWA","MBM")[apply(exp2_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","No_Tr_BIC","QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,which.min)])
...
for(id in unique(dat_exp2$human_id)) {
  ...
  min_BIC <- apply(id_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","No_Tr_BIC", "QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,min)
  
  best_model <- c("random","ToM_BT","ToM_NBT", "ToM_NT","QL_states","S_EWA", "MBM")[apply(id_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","No_Tr_BIC","QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,which.min)]
  # 
 exp2_model_comp <- rbind(exp2_model_comp ,
                       data.frame(
                         ...
                         "TR_minus_NT_BIC" = id_results[,"Btwn_TR_BIC"] - id_results[,"No_Btwn_Tr_BIC"],
