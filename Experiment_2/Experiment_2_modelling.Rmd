...
```{r}
exp2_table_results <- table(exp2_results[, "condition"],c("random","Bayes Tr","Bayes No Tr", "QL_states","S_EWA","MBM")[apply(exp2_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,which.min)])
...
for(id in unique(dat_exp2$human_id)) {
  ...
  min_BIC <- apply(id_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,min)
  
  best_model <- c("random","ToM_BT","ToM_NBT", "QL_states","S_EWA", "MBM")[apply(id_results[,c("Random_BIC","Btwn_TR_BIC","No_Btwn_Tr_BIC","QL_states_BIC","EWA_self_BIC","MBM2_BIC")],1,which.min)]
  # 
